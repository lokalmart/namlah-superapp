...
Semut-ID adalah akun portal Namlah. Untuk showcase ini, akun dibuat dan dibuka ulang dari localStorage dengan PIN 4 digit.
...
Role yang belum dimiliki mengarahkan user ke Akun untuk registrasi role. Role yang sudah dimiliki bisa dipindah langsung dari bar konteks agar user tidak perlu selalu masuk ke Akun hanya untuk memahami posisi kerja.
